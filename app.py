...
- Attempts to downscale images to meet Telgram photo post requirements
...
def send_file(file_path, post_info):
    ...
    with open(file_path, "rb") as file:
        response = requests.post(url, data={"chat_id": CHAT_ID, "caption":f"{post_info["artists"]}: <a href='https://e621.net/posts/{post_info["post_id"]}'>E621</a>", "parse_mode": "HTML"}, files={field:file})
